...
public class Qccommissiontype_config extends AbstractJavaBeanDefinition{
...
public nc.ui.pubapp.pub.smart.SmartBatchAppModelService getBatchModelaModelService(){
 if(context.get("batchModelaModelService")!=null)
 return (nc.ui.pubapp.pub.smart.SmartBatchAppModelService)context.get("batchModelaModelService");
  nc.ui.pubapp.pub.smart.SmartBatchAppModelService bean = new nc.ui.pubapp.pub.smart.SmartBatchAppModelService();
  context.put("batchModelaModelService",bean);
...
public nc.ui.qcco.qccommissiontype.model.CommissionTypeDataManager getModelDataManager(){
 if(context.get("modelDataManager")!=null)
 return (nc.ui.qcco.qccommissiontype.model.CommissionTypeDataManager)context.get("modelDataManager");
  nc.ui.qcco.qccommissiontype.model.CommissionTypeDataManager bean = new nc.ui.qcco.qccommissiontype.model.CommissionTypeDataManager();
...
public nc.ui.pubapp.uif2app.model.BatchBillTableModel getBatchModel(){
 ...
 return (nc.ui.pubapp.uif2app.model.BatchBillTableModel)context.get("batchModel");
  ...
  bean.setService(getBatchModelaModelService());
...
public nc.ui.qcco.qccommissiontype.model.CommissionTypeModelDataManager getBatchModelModelDataManager(){
 if(context.get("batchModelModelDataManager")!=null)
 return (nc.ui.qcco.qccommissiontype.model.CommissionTypeModelDataManager)context.get("batchModelModelDataManager");
  nc.ui.qcco.qccommissiontype.model.CommissionTypeModelDataManager bean = new nc.ui.qcco.qccommissiontype.model.CommissionTypeModelDataManager();
...
public nc.ui.qcco.qccommissiontype.ace.view.CommissionTypeEditor getBatchBillTable(){
 if(context.get("batchBillTable")!=null)
 return (nc.ui.qcco.qccommissiontype.ace.view.CommissionTypeEditor)context.get("batchBillTable");
  nc.ui.qcco.qccommissiontype.ace.view.CommissionTypeEditor bean = new nc.ui.qcco.qccommissiontype.ace.view.CommissionTypeEditor();
  ...
  bean.setResourceCode("C0J00201");
  bean.setVoClassName("nc.vo.qcco.qccommissiontype.CommissionTypeVO");
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.qcco.qccommissiontype.action.QccommissiontypeAddLineAction getBatchAddLineAction(){
 if(context.get("batchAddLineAction")!=null)
 return (nc.ui.qcco.qccommissiontype.action.QccommissiontypeAddLineAction)context.get("batchAddLineAction");
  nc.ui.qcco.qccommissiontype.action.QccommissiontypeAddLineAction bean = new nc.ui.qcco.qccommissiontype.action.QccommissiontypeAddLineAction();
...
public nc.ui.qcco.qccommissiontype.action.QccommissiontypeAddLineActiona getBatchAddLineActiona(){
 if(context.get("batchAddLineActiona")!=null)
 return (nc.ui.qcco.qccommissiontype.action.QccommissiontypeAddLineActiona)context.get("batchAddLineActiona");
  nc.ui.qcco.qccommissiontype.action.QccommissiontypeAddLineActiona bean = new nc.ui.qcco.qccommissiontype.action.QccommissiontypeAddLineActiona();
