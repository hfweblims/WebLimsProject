...
public class Qcmodelno_config extends AbstractJavaBeanDefinition{
...
public nc.ui.pubapp.pub.smart.SmartBatchAppModelService getBatchModelModelService(){
 ...
 return (nc.ui.pubapp.pub.smart.SmartBatchAppModelService)context.get("batchModelModelService");
  ...
  bean.setServiceItf("nc.itf.qcco.IQcmodelnoMaintain");
  bean.setVoClass("nc.vo.qcco.qcmodelno.ModelnoVO");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.qcco.qcmodelno.model.ModelNoDataManager getModelDataManager(){
 if(context.get("modelDataManager")!=null)
 return (nc.ui.qcco.qcmodelno.model.ModelNoDataManager)context.get("modelDataManager");
  nc.ui.qcco.qcmodelno.model.ModelNoDataManager bean = new nc.ui.qcco.qcmodelno.model.ModelNoDataManager();
...
public nc.ui.qcco.qcmodelno.model.ModelNoModelDataManager getBatchModelModelDataManager(){
 if(context.get("batchModelModelDataManager")!=null)
 return (nc.ui.qcco.qcmodelno.model.ModelNoModelDataManager)context.get("batchModelModelDataManager");
  nc.ui.qcco.qcmodelno.model.ModelNoModelDataManager bean = new nc.ui.qcco.qcmodelno.model.ModelNoModelDataManager();
...
public nc.ui.qcco.qcmodelno.ace.view.ModelNoEditor getBatchBillTable(){
 if(context.get("batchBillTable")!=null)
 return (nc.ui.qcco.qcmodelno.ace.view.ModelNoEditor)context.get("batchBillTable");
  nc.ui.qcco.qcmodelno.ace.view.ModelNoEditor bean = new nc.ui.qcco.qcmodelno.ace.view.ModelNoEditor();
  ...
  bean.setVoClassName("nc.vo.qcco.qcmodelno.ModelnoVO");
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
