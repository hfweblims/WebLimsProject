...
public class Qcentstandard_config extends AbstractJavaBeanDefinition{
...
public nc.ui.pubapp.pub.smart.SmartBatchAppModelService getBatchModelModelService(){
 ...
 return (nc.ui.pubapp.pub.smart.SmartBatchAppModelService)context.get("batchModelModelService");
  ...
  bean.setServiceItf("nc.itf.qcco.IQcentstandardMaintain");
  bean.setVoClass("nc.vo.qcco.qcentstandard.EntstandardVO");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.qcco.qcentstandard.model.EntStandardDataManager getModelDataManager(){
 if(context.get("modelDataManager")!=null)
 return (nc.ui.qcco.qcentstandard.model.EntStandardDataManager)context.get("modelDataManager");
  nc.ui.qcco.qcentstandard.model.EntStandardDataManager bean = new nc.ui.qcco.qcentstandard.model.EntStandardDataManager();
...
public nc.ui.qcco.qcentstandard.model.EntStandardModelDataManager getBatchModelModelDataManager(){
 if(context.get("batchModelModelDataManager")!=null)
 return (nc.ui.qcco.qcentstandard.model.EntStandardModelDataManager)context.get("batchModelModelDataManager");
  nc.ui.qcco.qcentstandard.model.EntStandardModelDataManager bean = new nc.ui.qcco.qcentstandard.model.EntStandardModelDataManager();
...
public nc.ui.qcco.qcentstandard.ace.view.EntStandardEditor getBatchBillTable(){
 if(context.get("batchBillTable")!=null)
 return (nc.ui.qcco.qcentstandard.ace.view.EntStandardEditor)context.get("batchBillTable");
  nc.ui.qcco.qcentstandard.ace.view.EntStandardEditor bean = new nc.ui.qcco.qcentstandard.ace.view.EntStandardEditor();
  ...
  bean.setResourceCode("C0J00103");
  bean.setVoClassName("nc.vo.qcco.qcentstandard.EntstandardVO");
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.qcco.qcentstandard.action.QcentstandardAddLineAction getBatchAddLineAction(){
 if(context.get("batchAddLineAction")!=null)
 return (nc.ui.qcco.qcentstandard.action.QcentstandardAddLineAction)context.get("batchAddLineAction");
  nc.ui.qcco.qcentstandard.action.QcentstandardAddLineAction bean = new nc.ui.qcco.qcentstandard.action.QcentstandardAddLineAction();
...
public nc.ui.qcco.qcentstandard.action.QcentstandardAddLineActiona getBatchAddLineActiona(){
 if(context.get("batchAddLineActiona")!=null)
 return (nc.ui.qcco.qcentstandard.action.QcentstandardAddLineActiona)context.get("batchAddLineActiona");
  nc.ui.qcco.qcentstandard.action.QcentstandardAddLineActiona bean = new nc.ui.qcco.qcentstandard.action.QcentstandardAddLineActiona();
