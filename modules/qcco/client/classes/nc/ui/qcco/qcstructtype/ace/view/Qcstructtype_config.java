...
public class Qcstructtype_config extends AbstractJavaBeanDefinition{
...
public nc.ui.pubapp.pub.smart.SmartBatchAppModelService getBatchModelModelService(){
 ...
 return (nc.ui.pubapp.pub.smart.SmartBatchAppModelService)context.get("batchModelModelService");
  ...
  bean.setServiceItf("nc.itf.qcco.IQcstructtypeMaintain");
  bean.setVoClass("nc.vo.qcco.qcstructtype.StructTypeVO");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.qcco.qcstructtype.model.StructTypeDataManager getModelDataManager(){
 if(context.get("modelDataManager")!=null)
 return (nc.ui.qcco.qcstructtype.model.StructTypeDataManager)context.get("modelDataManager");
  nc.ui.qcco.qcstructtype.model.StructTypeDataManager bean = new nc.ui.qcco.qcstructtype.model.StructTypeDataManager();
...
public nc.ui.qcco.qcstructtype.model.StructTypeModelDataManager getBatchModelModelDataManager(){
 if(context.get("batchModelModelDataManager")!=null)
 return (nc.ui.qcco.qcstructtype.model.StructTypeModelDataManager)context.get("batchModelModelDataManager");
  nc.ui.qcco.qcstructtype.model.StructTypeModelDataManager bean = new nc.ui.qcco.qcstructtype.model.StructTypeModelDataManager();
...
public nc.ui.qcco.qcstructtype.ace.view.StructTypeEditor getBatchBillTable(){
 if(context.get("batchBillTable")!=null)
 return (nc.ui.qcco.qcstructtype.ace.view.StructTypeEditor)context.get("batchBillTable");
  nc.ui.qcco.qcstructtype.ace.view.StructTypeEditor bean = new nc.ui.qcco.qcstructtype.ace.view.StructTypeEditor();
  ...
  bean.setResourceCode("C0J00106");
  bean.setVoClassName("nc.vo.qcco.qcstructtype.StructTypeVO");
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
public nc.ui.qcco.qcstructtype.action.QcstructtypeAddLineAction getBatchAddLineAction(){
 if(context.get("batchAddLineAction")!=null)
 return (nc.ui.qcco.qcstructtype.action.QcstructtypeAddLineAction)context.get("batchAddLineAction");
  nc.ui.qcco.qcstructtype.action.QcstructtypeAddLineAction bean = new nc.ui.qcco.qcstructtype.action.QcstructtypeAddLineAction();
...
public nc.ui.qcco.qcstructtype.action.QcstructtypeAddLineActiona getBatchAddLineActiona(){
 if(context.get("batchAddLineActiona")!=null)
 return (nc.ui.qcco.qcstructtype.action.QcstructtypeAddLineActiona)context.get("batchAddLineActiona");
  nc.ui.qcco.qcstructtype.action.QcstructtypeAddLineActiona bean = new nc.ui.qcco.qcstructtype.action.QcstructtypeAddLineActiona();
