package nc.ui.qcco.testlist.action;
...
public class TestlistDeleteAction extends nc.ui.pubapp.uif2app.actions.pflow.DeleteScriptAction {
	...
	private ISingleBillService<AggTestlistHVO> singleBillService;
	
	@Override
	public void doAction(ActionEvent e) throws Exception {
		Object value = this.getMainGrandModel().getDeleteAggVO();
		Object object = this.getSingleBillService().operateBill((AggTestlistHVO) value);
		this.getModel().directlyDelete(object);
		this.getMainGrandModel().directlyDelete(object);
		this.showSuccessInfo();
	}
	
	public TestlistDeleteAction() {
		super();
	...
	public ISingleBillService<AggTestlistHVO> getSingleBillService() {
		return singleBillService;
	}

	public void setSingleBillService(ISingleBillService<AggTestlistHVO> singleBillService) {
