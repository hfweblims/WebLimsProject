...
public class Qctestemperature_config extends AbstractJavaBeanDefinition{
...
public nc.ui.pubapp.pub.smart.SmartBatchAppModelService getBatchModelModelService(){
 ...
 return (nc.ui.pubapp.pub.smart.SmartBatchAppModelService)context.get("batchModelModelService");
  ...
  bean.setServiceItf("nc.itf.qcco.IQctestemperatureMaintain");
  bean.setVoClass("nc.vo.qcco.qctestemperature.TestemperatureVO");
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
}
...
public nc.ui.qcco.qctestemperature.model.TestEmperatureDataManager getModelDataManager(){
 if(context.get("modelDataManager")!=null)
 return (nc.ui.qcco.qctestemperature.model.TestEmperatureDataManager)context.get("modelDataManager");
  nc.ui.qcco.qctestemperature.model.TestEmperatureDataManager bean = new nc.ui.qcco.qctestemperature.model.TestEmperatureDataManager();
...
public nc.ui.qcco.qctestemperature.model.TestEmperatureModelDataManager getBatchModelModelDataManager(){
 if(context.get("batchModelModelDataManager")!=null)
 return (nc.ui.qcco.qctestemperature.model.TestEmperatureModelDataManager)context.get("batchModelModelDataManager");
  nc.ui.qcco.qctestemperature.model.TestEmperatureModelDataManager bean = new nc.ui.qcco.qctestemperature.model.TestEmperatureModelDataManager();
...
public nc.ui.qcco.qctestemperature.ace.view.TestEmperatureEditor getBatchBillTable(){
 if(context.get("batchBillTable")!=null)
 return (nc.ui.qcco.qctestemperature.ace.view.TestEmperatureEditor)context.get("batchBillTable");
  nc.ui.qcco.qctestemperature.ace.view.TestEmperatureEditor bean = new nc.ui.qcco.qctestemperature.ace.view.TestEmperatureEditor();
  ...
  bean.setVoClassName("nc.vo.qcco.qctestemperature.TestemperatureVO");
  bean.initUI();
setBeanFacotryIfBeanFacatoryAware(bean);
invokeInitializingBean(bean);
return bean;
...
private List getManagedList1(){  List list = new ArrayList();  list.add(getTangramLayoutConstraint_15e54e8());  return list;}

private nc.ui.uif2.tangramlayout.TangramLayoutConstraint getTangramLayoutConstraint_15e54e8(){
 if(context.get("nc.ui.uif2.tangramlayout.TangramLayoutConstraint#15e54e8")!=null)
 return (nc.ui.uif2.tangramlayout.TangramLayoutConstraint)context.get("nc.ui.uif2.tangramlayout.TangramLayoutConstraint#15e54e8");
  nc.ui.uif2.tangramlayout.TangramLayoutConstraint bean = new nc.ui.uif2.tangramlayout.TangramLayoutConstraint();
  context.put("nc.ui.uif2.tangramlayout.TangramLayoutConstraint#15e54e8",bean);
...
public nc.ui.qcco.qctestemperature.action.QctestemperatureAddLineAction getBatchAddLineAction(){
 if(context.get("batchAddLineAction")!=null)
 return (nc.ui.qcco.qctestemperature.action.QctestemperatureAddLineAction)context.get("batchAddLineAction");
  nc.ui.qcco.qctestemperature.action.QctestemperatureAddLineAction bean = new nc.ui.qcco.qctestemperature.action.QctestemperatureAddLineAction();
...
public nc.ui.qcco.qctestemperature.action.QctestemperatureAddLineActiona getBatchAddLineActiona(){
 if(context.get("batchAddLineActiona")!=null)
 return (nc.ui.qcco.qctestemperature.action.QctestemperatureAddLineActiona)context.get("batchAddLineActiona");
  nc.ui.qcco.qctestemperature.action.QctestemperatureAddLineActiona bean = new nc.ui.qcco.qctestemperature.action.QctestemperatureAddLineActiona();
