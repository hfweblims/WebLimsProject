package nc.vo.qcco.qcstructtype;
...
public class StructTypeVO extends SuperVO {
	private static final long serialVersionUID = -3533220441281677311L;
/**
*主键
*/
...
/**
* 属性 pk_structtype的Getter方法.属性名：主键
*  创建日期:2018-12-5
...
/**
* 属性pk_structtype的Setter方法.属性名：主键
* 创建日期:2018-12-5
* @param newPk_structtype java.lang.String
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("qcco.structtype");
    }
   }
