...
public class AnalyseMethodHVO extends SuperVO {
	
/**
	 * 
	 */
	private static final long serialVersionUID = -5855669015742742687L;
/**
*主键
*/
...
/**
* 属性 pk_analysemethod的Getter方法.属性名：主键
*  创建日期:2018-12-5
...
/**
* 属性pk_analysemethod的Setter方法.属性名：主键
* 创建日期:2018-12-5
* @param newPk_analysemethod java.lang.String
*/
...
/**
* 属性 pk_analyzetype的Getter方法.属性名：分析类型
*  创建日期:2018-12-5
* @return nc.vo.bd.defdoc.DefdocVO
*/
public String getPk_analyzetype() {
return this.pk_analyzetype;
} 

/**
* 属性pk_analyzetype的Setter方法.属性名：分析类型
* 创建日期:2018-12-5
* @param newPk_analyzetype nc.vo.bd.defdoc.DefdocVO
*/
public void setPk_analyzetype ( String pk_analyzetype) {
this.pk_analyzetype=pk_analyzetype;
} 
...
* 创建日期:2018-12-5
* @param newIsreport nc.vo.pub.lang.UFUFBoolean
*/
...
* 创建日期:2018-12-5
* @param newSelectable nc.vo.pub.lang.UFUFBoolean
*/
...
* 创建日期:2018-12-5
* @param newIscarry nc.vo.pub.lang.UFUFBoolean
*/
...
* 创建日期:2018-12-5
* @param newHasprop nc.vo.pub.lang.UFUFBoolean
*/
...
* 创建日期:2018-12-5
* @param newIsformatcalc nc.vo.pub.lang.UFUFBoolean
*/
...
* 创建日期:2018-12-5
* @param newIsdisplay nc.vo.pub.lang.UFUFBoolean
*/
...
/**
* 属性 sourcetype的Getter方法.属性名：来源类型
*  创建日期:2018-12-5
* @return java.lang.String
*/
...
/**
* 属性sourcetype的Setter方法.属性名：来源类型
* 创建日期:2018-12-5
...
/**
* 属性 cbilldate的Getter方法.属性名：制单日期
*  创建日期:2018-12-5
* @return nc.vo.pub.lang.UFDate
*/
public UFDate getCbilldate() {
return this.cbilldate;
} 

/**
* 属性cbilldate的Setter方法.属性名：制单日期
* 创建日期:2018-12-5
* @param newCbilldate nc.vo.pub.lang.UFDate
*/
public void setCbilldate ( UFDate cbilldate) {
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("qcco.analysemethod");
    }
   }
