package nc.vo.qcco.qcproductserial;
...
public class ProductSerialVO extends SuperVO {
	
/**
	 * 
	 */
	private static final long serialVersionUID = -6433854152877348236L;
/**
*主键
*/
...
/**
* 属性 pk_productserial的Getter方法.属性名：主键
*  创建日期:2018-12-5
...
/**
* 属性pk_productserial的Setter方法.属性名：主键
* 创建日期:2018-12-5
* @param newPk_productserial java.lang.String
*/
...
/**
* 属性 pk_category的Getter方法.属性名：产品分类
*  创建日期:2018-12-5
...
/**
* 属性pk_category的Setter方法.属性名：产品分类
* 创建日期:2018-12-5
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("qcco.productserial");
    }
   }
