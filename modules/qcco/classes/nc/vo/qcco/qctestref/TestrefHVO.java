...
public class TestrefHVO extends SuperVO {
	
/**
	 * 
	 */
	private static final long serialVersionUID = -2701552331768568829L;
/**
*主键
*/
...
* 创建日期:2018-12-5
* @param newPk_testtemp nc.vo.qcco.qctestemperature.TestemperatureVO
*/
...
/**
* 属性 cancelable的Getter方法.属性名：是否允许撤销
*  创建日期:2018-12-5
* @return nc.vo.pub.lang.UFBoolean
*/
...
/**
* 属性cancelable的Setter方法.属性名：是否允许撤销
* 创建日期:2018-12-5
...
/**
* 属性 fileversion的Getter方法.属性名：文件版本
*  创建日期:2018-12-5
* @return java.lang.String
*/
...
/**
* 属性fileversion的Setter方法.属性名：文件版本
* 创建日期:2018-12-5
* @param newFileversion java.lang.String
*/
...
/**
* 属性reftype的Setter方法.属性名：参数类型
* 创建日期:2018-12-5
* @param newReftype java.lang.Integer
*/
...
this.ts=ts;
    ...
    return VOMetaFactory.getInstance().getVOMeta("qcco.testref");
    }
   }
