...
*报告格式
*/
public Integer reportformat;
/**
*报告语言
*/
public Integer reportlang;
/**
*发送消息标记
*/
...
*  创建日期:2018-11-12
* @return nc.vo.qcco.commission.ReportFormatEnum
*/
...
* 创建日期:2018-11-12
* @param newReportformat nc.vo.qcco.commission.ReportFormatEnum
*/
...
*  创建日期:2018-11-12
* @return nc.vo.qcco.commission.ReportLanguageEnum
*/
public Integer getReportlang() {
...
* 创建日期:2018-11-12
* @param newReportlang nc.vo.qcco.commission.ReportLanguageEnum
*/
public void setReportlang ( Integer reportlang) {
...
*  创建日期:2018-11-12
* @return nc.vo.qcco.commission.SPAfterInspectEnum
*/
public Integer getSampledealtype() {
...
* 创建日期:2018-11-12
* @param newSampledealtype nc.vo.qcco.commission.SPAfterInspectEnum
*/
public void setSampledealtype ( Integer sampledealtype) {
